...
@AutoValue
public abstract class CategoryPointsModel implements Parcelable {
    ...
    public static Builder builder() {
        return new AutoValue_CategoryPointsModel.Builder();
    }
    ...
    public static abstract class Builder {
        ...
        public abstract CategoryPointsModel build();
    }

    public static JsonAdapter<CategoryPointsModel> jsonAdapter(Moshi moshi) {
        return new AutoValue_CategoryPointsModel.MoshiJsonAdapter(moshi);
    }
