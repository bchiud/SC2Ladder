...
import model.profile.Campaign;
import model.profile.Career;
import model.profile.ProfileRewards;
import model.profile.Season;
...
public abstract class Profile {
    ...
    @Json(name = "achievements") public abstract model.profile.ProfileAchievementList profileAchievementList();
    ...
    public static abstract class Builder {
        ...
        public abstract Builder setProfileAchievementList(model.profile.ProfileAchievementList value);
